            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="course-item bg-light">
                    ...
                    <div class="text-center p-4 pb-0">
                        ...
                        <a href="{{ route('readmore', ['id'=>$exam->id]) }}" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;"> Học Ngay</a>
                        <div class="mb-3">
                    ...
                    <div class="d-flex border-top">
                        ...
                        <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i> views</small>
                    </div>
                </div>
            </div>  
