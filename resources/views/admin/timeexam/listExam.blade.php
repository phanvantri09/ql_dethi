                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('add.list.student', ['id_exam'=>$pro,'id_time_exam'=>$id])}}">
                                                <button style="margin-right: 10px;" type="submit" class="btn btn-primary btn-sm">Thêm sinh viên</button>
                                            </a>
                                            <a href="{{route('diemthi', ['id_exam'=>$pro,'id_time_exam'=>$id])}}">
                                                <button style="margin-right: 10px;" type="submit" class="btn btn-secondary btn-sm">Xem điểm thi của sinh viên</button>
                                            </a>

                                        </td>
                                        {{-- <input style="display:none" type="text" value="{{ route('linkExamRun', ['id'=>$id,'id_exam_random'=>$pro->id]) }}" id="InputLink{{$key}}">
